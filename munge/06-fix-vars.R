treatvars <- c("sos_lm_bbl", "sos_lm_rasiarni", "sos_lm_mra", "sos_lm_sglt2i", "sos_lm_ivabradin", "sos_lm_loopdiuretics", "sos_lm_digoxin", "sos_lm_nitrate")
...
rsdata <- rsdata %>%
  mutate(
    ...
    ), levels = 0:4, labels = c("None", "Mono", "Double", "Tripple", "Quadruple"))
  ) %>%
