...
2. The prescription can be old and the doctor can verbally have instructed the patient to take a different dose/stop medication.
...
Together with HF duration $\le$ 6 months the inclusion criteria is also that the patient needs to be medication naive for SGLT2i, RASi/ARNi, Beta-blocker and MRA (defined as not taking any of these drugs 4-12 months prior to baseline). 
...
No output: See the results for the primary endpoint/secondary objective 6. 
...
- heart rate $\ge$ 50 beats/minute or Beta-blocker
- eGFR $\ge$ 30 mL/min/1.73 or MRA or SGLT2i
- potassium $\le$ 5.0 mEq/L or MRA
- no diabetes type 1 or SGLT2i. 
...
From protocol under Analyses for the secondary objectives: NA
...
https://github.com/KIHeartFailure/swedehf-hftreat. On publication
