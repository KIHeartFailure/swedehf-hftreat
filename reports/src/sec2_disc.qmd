```{r}
#| label: tbl-sec2-discontinuation
#| cache: true
...
rsdatatmp <- rsdata %>%
  ...
  mutate(
    fu_sos_lm_bbl = factor(if_else(sos_lm_bbl == "No", NA_real_, fu_sos_lm_bbl), levels = 0:1, labels = c("No", "Yes")),
    fu_sos_lm_mra = factor(if_else(sos_lm_mra == "No", NA_real_, fu_sos_lm_mra), levels = 0:1, labels = c("No", "Yes")),
    fu_sos_lm_acei = factor(if_else(sos_lm_acei == "No", NA_real_, fu_sos_lm_acei), levels = 0:1, labels = c("No", "Yes")),
    fu_sos_lm_arb = factor(if_else(sos_lm_arb == "No", NA_real_, fu_sos_lm_arb), levels = 0:1, labels = c("No", "Yes")),
    fu_sos_lm_arni = factor(if_else(sos_lm_arni == "No", NA_real_, fu_sos_lm_arni), levels = 0:1, labels = c("No", "Yes")),
    fu_sos_lm_rasiarni = factor(if_else(sos_lm_rasiarni == "No", NA_real_, fu_sos_lm_rasiarni), levels = 0:1, labels = c("No", "Yes")),
    fu_sos_lm_sglt2i = factor(if_else(sos_lm_sglt2i == "No", NA_real_, fu_sos_lm_sglt2i), levels = 0:1, labels = c("No", "Yes"))
  ) %>%
  rowwise() %>%
  ...
  if (is.null(byvar)) {
    ...
    tab <- rsdatatmp %>%
      ...
      filter(!!sym(medvar) == "Yes" &
        ...
        sos_lm_gdmt != "None" &
        !(shf_indexyear_cat == "2016-2020" & Medication == "fu_sos_lm_sglt2i")) %>%
