...
primaryfunc <- function(data = rsdata, colvar = NULL, yearvar = "shf_indexyear_cat") {
  ...
  tabprint <- default_kable(tab,
    ...
    footnote(
      ...
      general_title = "",
      general = c(
        "Presented with n (%). The groups are not mutually exclusive and the percent will therfore not sum to 100."
      ),
      threeparttable = T
    ) %>%
...
#| cache.comments: false
#| dependson: primaryfunc
#| tbl-cap: "Beta-blocker, ACEi/ARB/ARNi, MRA, SGLT2i by area of previous HFH within 3 months"
#| tbl-pos: "H"
