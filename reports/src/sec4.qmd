...
#| tbl-cap: "Secondary objective 4 - Sequence of initiation of Beta-blocker, RASi/ARNi, MRA and SGLT2i"
#| tbl-pos: "H"
...
default_kable(outall,
  ...
  footnote(
    ...
    general = c(
      ...
      "The outcomes are presented as Number of events, incidence/100 person-years (95% CI) for groups > 10 patients."
    ),
    threeparttable = T
  ) %>%
