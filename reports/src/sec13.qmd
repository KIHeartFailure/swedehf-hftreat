...
who are not taking dapagliflozin and who would be eligible (not type I diabetes and eGFR $>=$ 25) (2021-2023) is `r tab6mo %>% pull(np)` and `r tab1yr %>% pull(np)` respectively. 
