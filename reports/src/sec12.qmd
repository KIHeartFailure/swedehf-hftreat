...
colnames(tab6mo) <- c("Change in Beta-blocker dose", "6 months")
colnames(tab1yr) <- c("Change in Beta-blocker dose", "1 year")

tabboth <- full_join(tab6mo, tab1yr, by = c("Change in Beta-blocker dose"))
